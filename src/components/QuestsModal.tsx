  ...
  const quests: Quest[] = [
    {
      ...
      rewardPigment: {
        pigmentName: 'Radical Red',
        hex: '#FF3366',
        emoji: '✨',
        rarity: 'Rare',
        category: 'Secondary',
        description: 'A bright red pigment awarded for your first mix.',
      },
    },
    {
      id: 'q1',
      title: 'Spectrum Initiate',
      description: 'Discover at least 10 unique pigments and add them to your journal.',
      targetType: 'count',
      targetValue: 10,
      requiredAmount: 10,
      ...
      rewardPigment: {
        pigmentName: 'Deep Sky Blue',
        hex: '#00B4D8',
        emoji: '📜',
        rarity: 'Uncommon',
        category: 'Secondary',
        description: 'A clear sky blue pigment for new alchemists.',
      },
    },
    {
      id: 'q2',
      title: 'Neon Catalyst',
      description: 'Mix any Neon category pigment.',
      targetType: 'category',
      targetValue: 'Neon',
      requiredAmount: 1,
      ...
      rewardPigment: {
        ...
        rarity: 'Rare',
        category: 'Neon',
        description: 'A bright electric green.',
      },
    },
    {
      id: 'q3',
      ...
      rewardPigment: {
        pigmentName: 'Cherry Blossom Pink',
        hex: '#FFB7B2',
        emoji: '🌸',
        rarity: 'Rare',
        category: 'Pastel',
        description: 'A soft pink pastel.',
      },
    },
    {
      id: 'q4',
      title: 'Dark Shadow Alchemist',
      description: 'Discover 3 Dark category pigments by mixing with Black.',
      targetType: 'category',
      targetValue: 'Dark',
      requiredAmount: 3,
      ...
      rewardPigment: {
        ...
        rarity: 'Rare',
        category: 'Dark',
        description: 'An almost pure black shade.',
      },
    },
    {
      id: 'q5',
      ...
      rewardPigment: {
        ...
        rarity: 'Rare',
        category: 'Metallic',
        description: 'A classic metallic bronze.',
      },
    },
    {
      id: 'q6',
      title: 'Cosmic Voyager',
      description: 'Mix any Cosmic category pigment.',
      targetType: 'category',
      targetValue: 'Cosmic',
      requiredAmount: 1,
      ...
      rewardPigment: {
        pigmentName: 'Amethyst',
        hex: '#9D4EDD',
        emoji: '🌌',
        rarity: 'Epic',
        category: 'Cosmic',
        description: 'A rich violet purple.',
      },
    },
    {
      id: 'q7',
      ...
      rewardPigment: {
        ...
        rarity: 'Rare',
        category: 'Secondary',
        description: 'A bright aqua teal.',
      },
    },
    {
      id: 'q8',
      title: 'Legendary Synthesizer',
      description: 'Discover an Epic or Legendary pigment through multi-step mixing.',
      targetType: 'rarity',
      ...
      rewardPigment: {
        ...
        rarity: 'Legendary',
        category: 'Metallic',
        description: 'A rich metallic gold.',
      },
    },
    {
      id: 'q9',
      title: 'Godlike Alchemist',
      description: 'Mix a God tier pigment (Gold or Silver).',
      targetType: 'rarity',
      targetValue: 'God',
      requiredAmount: 1,
      ...
      rewardPigment: {
        ...
        rarity: 'God',
        category: 'Cosmic',
        description: 'A pale violet purple.',
      },
    },
    {
      id: 'q10',
      ...
      rewardPigment: {
        ...
        rarity: 'Legendary',
        category: 'Cosmic',
        description: 'A deep royal purple.',
      },
    },
    {
      id: 'q11',
      ...
      rewardPigment: {
        ...
        rarity: 'God',
        category: 'Neon',
        description: 'A warm bright orange.',
      },
    },
  ];
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className={`text-xs font-black uppercase ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>
                Complete milestones to earn bonus pigments and badges!
              </p>
            </div>
